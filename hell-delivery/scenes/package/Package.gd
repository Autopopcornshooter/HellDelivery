...
@export var follow_strength: float = 8.0 # TODO: 프로토타입 값, 튜닝 필요
@export var max_follow_speed: float = 6.0 # TODO: 프로토타입 값, 튜닝 필요
@export var follow_acceleration: float = 40.0 # TODO: 프로토타입 값, 튜닝 필요
@export var max_hold_distance: float = 3.0 # TODO: 프로토타입 값, 튜닝 필요
